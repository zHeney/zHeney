function startSongByName(trakTitle,players){
    for(keyPlayer in players){
...
// ************************************************  Gloomy-Hop
        ...
        new jPlayerPlaylist({
            ...
            {title:"Faceless feat Eastman",
            mp3:"http://sukinsan.com/zheney/Gloomy-Hop/Faceless_feat_Eastman.mp3"},
...
// ************************************************  90bpm-HipHop
        ...
        new jPlayerPlaylist({
            ...
            {title:"My region",
            mp3:"http://sukinsan.com/zheney/90bpm-HipHop/My_region.mp3"},
...
// ************************************************  Sympho
        ...
        new jPlayerPlaylist({
            ...
            {title:"History about one artist",
